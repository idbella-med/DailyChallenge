...
int main(int ac, char **av) {
    // this prog just for numbers pass char or string please it will terminat (crash)
    if (ac != 2)
        return (cout << "./prog \"numbers\"", 1);
    ...
    Solution s;
    int res = s.scoreDifference(n);
    cout << "Here is your result: " << res  << endl;
}
